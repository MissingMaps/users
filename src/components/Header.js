          ...
          <ul>
            <li className="nav-item nav-dropdown">
              ...
              <div className="dropdown-content nav-events">
                <a href="https://www.missingmaps.org/beginner/"><div className="nav-item">BEGINNER MAPPING</div></a>
                <a href="https://www.missingmaps.org/advanced/"><div className="nav-item">ADVANCED MAPPING</div></a>
                <a href="https://www.missingmaps.org/field/"><div className="nav-item">FIELD MAPPING</div></a>
                <a href="https://www.missingmaps.org/validate/"><div className="nav-item">VALIDATION</div></a>
                <a href="https://www.missingmaps.org/mapswipe/"><div className="nav-item">MAPSWIPE</div></a>
              </div>
            </li>
            <li className="nav-item nav-dropdown">
              EVENTS
