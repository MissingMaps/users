...
function mapBadgeToDescrip (badge) {
  var map = {
    ...
    'Whitewater Rafting': 'Waterways, rivers, streams and more. Adding water features to the map adds regional context and valuable information in the event of flooding. Add these features to reach new levels of this badge.',
...
function mapBadgeToTask (badge, x) {
  var map = {
    ...
    'Whitewater Rafting': (x) => `Add ${x} more km of waterways.`,
